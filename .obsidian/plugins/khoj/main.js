...
var KhojChatView = class extends KhojPaneView {
  ...
  renderMessageWithReferences(chatEl, message, sender, context, onlineContext, dt, intentType, inferredQueries, conversationId, images, excalidrawDiagram, mermaidjsDiagram) {
    if (!message)
      return;
    let chatMessageEl;
